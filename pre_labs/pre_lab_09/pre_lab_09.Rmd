...
My URL: <https://datawrapper.dwcdn.net/xxql3/1/>
...
**Task** Look for "Hide regions without data" under Appearance, and click the slider icon to enable that feature. You should see a map zoomed into Maryland with some counties in various colors. **Answer** Describe the changes from the previous map. Once I clicked on the "Crop to data" button under the subhead "Map view," I found the "Hide regions without data" button and clicked it. What used to be a whole map with all the states and its regions bordered with a little colorful section within Maryland, turned out to be a slanted map of Maryland with various blue hues, potentially showing the percentage of Gov. Wes Moore votes. The darker the blue, the higher the percentage of Moore votes in a county. Essentially, after hiding the regions without data, the map zoomed into Maryland, showing all the specific counties and its percentage of Moore votes. Before it was several gray states and counties across the U.S. with a section of blue signifying the Maryland voting data for governor across counties. 
...
Now, the tooltips show what county the zip codes represent and rounds the voting percentages of Wes Moore to the nearest tenths place. Before, the tooltips solely showed the zip code and the long percentage, but now it's more specific to each county. It's much cleaner and easier to read/visualize. 
...
**Answer** Zoom in to see the other county names! Highlighted Prince George's County and Baltimore City. 

Ok, that looks better. Let's publish!

**Task** Click the "Proceed" button until you get to the "Publish & Embed" tab, then click "Publish Now". Copy the published URL (like you did for the chart above) and paste it below. **Answer** Put the URL of your map here. <https://datawrapper.dwcdn.net/Jwdrs/1/>
