...
* **We grouped payouts into three size categories (<500K, $500K-$5M, >$5M) and calculated totals. The results confirm that while a few multimillion-dollar payouts contribute heavily, a large number of moderately sized payouts also substantially increases the total legal payout. More importantly, the results confirm that the largest portion of payouts are over $5 million (1,161,404,203). Additionally, the results show that the nearly 66% of the total payouts were above $5 million, which is significantly more than the other ranges.**: [Write up two to three sentences describing the results of your analysis.  Were you able to confirm the finding? If not, why not?]
...
* **The dataset contains 18,703 rows, which confirms the reported number of payouts analyzed. It shows that indeed there are more than 18,000 payouts dating back to July 2005 since that is when the payouts excel spreadsheet dates to.**: [Write up two to three sentences describing the results of your analysis.  Were you able to confirm the finding? If not, why not?]
